...
public class TestGetInsightsForNewBill extends Base {
	...
	String accountEntitySchema = "NewBillAccountEntity.json";
	String viewEntitySchema = "NewBillViewEntity.json";
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("NewBillV2" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("NewBillV2");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetNewBillInsight.csv")
