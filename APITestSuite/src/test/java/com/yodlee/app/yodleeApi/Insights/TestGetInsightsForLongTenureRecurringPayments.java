...
public class TestGetInsightsForLongTenureRecurringPayments extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForLongTenureRecurringPayments.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("LongTenRecrPaymt" + System.currentTimeMillis());
	   ...
	   // userHelper.getUserSession(userInfo.getUsername(),userInfo.getPassword(),sessionObj)	;	
		...
		"LongTenRecuPaymts.site16441.1", "site16441.1", sessionObj);
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("LongTenureRecurringPayments");
		automationTestResults.setBuildNo("168");
		automationTestResults.setCodeCoveragePercent("78");
		automationTestResults.setStoryId("B-67095");
	}


	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\LongTenureRecurringPayments\\GetLongTenureRecurringPaymentsInsight.csv")
	public void testGetNotificationsForLongTenureRecurringPayments(String testCaseId,String testCaseDescription,String insightName,String verifyTriggerCheck,
			...
			,String isCobrandSubscribed,String isUserSubscribed,String patchEntityIds,String expectedInsightsForPatchedIds,String expectedNumberOfPatchedInsights,String validateKeys,
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  BillNotPaid Insight",testInfo);		
