...
public class TestGetInsightsForProjectedInsufficientBalance extends Base {
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("projLowBal" + System.currentTimeMillis());
		//userInfo.setUsername("lbwinsightusr1"); //sense user and wellness
		//userInfo.setUsername("lbw115");
		...
		"ProjInsuffBal.site16441.2", "site16441.2", sessionObj);
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("ProjectedInsufficientBalance");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\ProjectedInsufficientBalance\\GetProjectedInsufficientBalanceInsight.csv")
	public void testGetNotificationsForTestGetInsightsForProjectedInsufficientBalanc(String testCaseId,String testCaseDescription,String insightName,String triggerType,String entityParamsCount,String entityParameterName,String thresholdNameValueType,String noumberOfInsights,String editSubscription
			,String isCobrandSubscribed,String isUserSubscribed,String patchEntityIds,String expectedInsightsForPatchedIds,String expectedNumberOfPatchedInsights,String validateKeys,String frequency,String expectedStatus,String tcEnabled) throws ParseException, InterruptedException, IOException {
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  ProjectedInsufficientBalance Insight",testInfo);		
