...
public class TestGetInsightsForAggregateInsuranceAccount extends Base {
	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForAggregateInsuranceAccount.class);
	...
	String accountEntity ="AggregateInsuranceAccount.json";
	
	public void setUp(String credentials) throws Exception {
		System.out.println("Initiated execution for Aggregate Insurance Account Insight");
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("TestGetInsightsForAggregateInsuranceAccount");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetAggregateInsuranceAccountInsight.csv")
	public void testGetNotificationsForAggregateInsuranceAccount(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String noumberOfInsights,String editSubscription
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  AggregateInsuranceAccount Insight",testInfo);		
