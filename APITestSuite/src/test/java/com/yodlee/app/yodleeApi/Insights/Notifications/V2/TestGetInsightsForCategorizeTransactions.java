...
public class TestGetInsightsForCategorizeTransactions extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForLargeDepositNotice.class);
	...
	String accountEntitySchema = "CategorizeTransactionsAccountEntity.json";
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("GetCategorizedTxnsV2" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("CategorizeTransactionsV2");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetCategorizeTransactionsInsight.csv")
	public void testGetNotificationsForCategorizeTransactions(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,
		...
		if(testCaseId.equals("AT-146278")) {
		...
		if (Boolean.parseBoolean(editSubscription)) {
			if (!isCobrandSubscribed.isEmpty()) {		
				try {					
					if(!isCobrandSubscribed.equals("NA")) {
						String patchCobSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(InsightsConstants.COB_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,thresholdNameValueType,"",duration,editSubscription,isCobrandSubscribed,"",entityIdsMap);
			...
			if (!isUserSubscribed.isEmpty()) {    
				String patchUserSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(InsightsConstants.USER_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,thresholdNameValueType,"",duration,editSubscription,isUserSubscribed,patchEntityIds,entityIdsMap);
