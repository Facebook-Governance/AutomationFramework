...
public class TestGetInsightsForRefundDepositNotice extends Base {
	...
	public void setUp() throws Exception {
	   ...
	   // userHelper.getUserSession(userInfo.getUsername(),userInfo.getPassword(),sessionObj)	;	
		...
		"refundDepositNotice.site16441.2", "site16441.2", sessionObj);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\RefundDeposit\\GetRefundDepositInsight.csv")
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  RefundDeposit Insight",testInfo);		
