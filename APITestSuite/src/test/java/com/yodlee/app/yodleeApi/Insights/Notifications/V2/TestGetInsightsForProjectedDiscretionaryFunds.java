...
public class TestGetInsightsForProjectedDiscretionaryFunds extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForProjectedDiscretionaryFunds.class);
	...
	String accountEntitySchema = "ProjectedDiscretionaryFundsAccountEntitySchema.json";
	...
	public void setUp() throws Exception {
		...
		userInfo.setUsername("ProjectedDiscretionaryFundsV2" + System.currentTimeMillis());
		...
		Response response = providerAccountUtils.addProviderAccountStrict(providerId, "fieldarray", "generic.bank14",
				"bank14", sessionObj);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetProjectedDiscretionaryFunds.csv")
	public void testGetNotificationsForPojectedDiscretionaryFunds(String testCaseId, String testCaseDescription,
			String insightName, String verifyTriggerCheck, String triggerType, String entityParamsCount,
			String entityParameterName, String noumberOfInsights, String editSubscription, String isCobrandSubscribed,
