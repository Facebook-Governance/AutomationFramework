...
public class TestGetInsightsForAggregateInvestmentAccount extends Base {
	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForAggregateInvestmentAccount.class);
	...
	String accountEntity ="AggregateInvestmentAccount.json";
	
	public void setUp(String credentials) throws Exception {
		System.out.println("Initiated execution for Aggregate Investment Account Insight");
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("TestGetInsightsForAggregateInvestmentAccount");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetAggregateInvestmentAccountInsight.csv")
	public void testGetNotificationsForAggregateInvestmentAccount(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String noumberOfInsights,String editSubscription
