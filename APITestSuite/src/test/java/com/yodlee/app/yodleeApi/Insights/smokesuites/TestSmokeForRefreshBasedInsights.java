...
public class TestSmokeForRefreshBasedInsights extends Base {
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("RefreshUser" + System.currentTimeMillis());
		//userInfo.setUsername("refreshuser5"); //sense user and wellness
		...
		"refreshtypeinsight.site16441.1", "site16441.1", sessionObj);		
		...
		entityIdsMap = insightsGenerics.getItemAccounts(sessionObj,"");		
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setStoryId("REFRESH Insights");
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\InsightsSmokeTest\\GetRefreshBasedInsights.csv")
	public void testGetRefreshBasedInsights(String testCaseId,String testCaseDescription,String insightName,String supportedContainers,
			...
			,String isCobrandSubscribed,String isUserSubscribed,String viewsRules,String viewRuleAccountNames,String validateKeys,String expectedStatus,String tcEnabled) throws ParseException, InterruptedException, IOException, SQLException {
		
		commontUtils.isTCEnabled(tcEnabled, testCaseId);
		String patchAccountIds = "";
		logger.info("Testcase executed --------->"+testCaseId);
		logger.info("Smoke Test for Refresh Based Insight " +insightName +" "+testCaseDescription);
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  REFRESH Based Insight",testInfo);		
