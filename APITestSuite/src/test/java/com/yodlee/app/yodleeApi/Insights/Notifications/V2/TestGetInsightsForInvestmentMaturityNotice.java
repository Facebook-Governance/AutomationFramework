...
public class TestGetInsightsForInvestmentMaturityNotice extends Base {
	...
	String accountEntitySchema = "InvestmentMaturityNoticeAccountEntity.json";
	
	@BeforeClass(alwaysRun = true)
	public void setUp() throws Exception {
		
		System.out.println("initiated execution for Large Deposit Notice Insight");	
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetInvestmentMaturityNoticeInsight.csv")
