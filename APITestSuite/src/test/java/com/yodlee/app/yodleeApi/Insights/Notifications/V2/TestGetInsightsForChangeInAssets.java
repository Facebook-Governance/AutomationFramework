...
public class TestGetInsightsForChangeInAssets extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForChangeInAssets.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Change in Assets Insight");
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("Assets CHANGE");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetChangeInAssets.csv")
	public void testGetNotificationsForChangeInAssets(String testCaseId,
