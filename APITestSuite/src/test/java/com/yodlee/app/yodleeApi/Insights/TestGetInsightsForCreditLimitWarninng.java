...
public class TestGetInsightsForCreditLimitWarninng extends Base {
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForCreditLimitWarninng.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("CredLimitWarn" + System.currentTimeMillis());
	...
	@Source("\\TestData\\CSVFiles\\Insights\\CreditLimitWarning1\\GetCreditLimitWarningInsight.csv")
	public void testGetNotificationsForCreditLimitWarning(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,
