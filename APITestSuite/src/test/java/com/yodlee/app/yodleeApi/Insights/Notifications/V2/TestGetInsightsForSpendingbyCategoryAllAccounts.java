...
public class TestGetInsightsForSpendingbyCategoryAllAccounts extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForSpendingbyCategoryAllAccounts.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Spending By Category AllAccounts Insight");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetSpendCatAllAcctsInsight.csv")
	...
	public void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("SpendingCategoryAllAcc" + System.currentTimeMillis());
