...
public class TestGetInsightsForRefundDepositNotice extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForRefundDepositNotice.class);
	...
	String accountEntitySchema ="RefundDepositAccountEntity.json";
	String viewEntitySchema = "RefundDepositViewEntity.json";
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("RefundDepositNotice" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("RefundDepositNotice");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetRefundDepositInsight.csv")
	public void testGetNotificationsForRefundDepositNotice(String testCaseId,String testCaseDescription,String insightName,String verifyTriggerCheck,
