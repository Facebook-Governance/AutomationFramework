...
public class TestGetInsightsForSpendingbyCategory extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForSpendingbyCategory.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Spending By Category Insight");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetSpendingbyCategoryInsight.csv")
	public void testGetNotificationsForSpendingbyCategory(String testCaseId, String testCaseDescription, String insightName,
