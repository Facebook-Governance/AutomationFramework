...
public class TestGetInsightsForEmergencySavings extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForEmergencySavings.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Emergency Savings Insight");
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("Emergency Savings");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetEmergencySavingsInsight.csv")
	public void testGetNotificationsForEmergencySavings(String testCaseId, String testCaseDescription,
			...
			String isCobrandSubscribed, String isUserSubscribed, String schema, String accountName, String patchEntityIds,
	...
	public void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("EmerSavings" + System.currentTimeMillis());
