...
public class TestGetInsightsForNetworthChange extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForNetworthChange.class);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\ChangeInNetworth\\GetNetworthChangeInsight.csv")
	public void testGetNotificationsForNetworthChange(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,
