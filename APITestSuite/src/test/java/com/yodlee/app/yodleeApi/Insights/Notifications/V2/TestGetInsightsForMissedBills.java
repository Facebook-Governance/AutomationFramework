...
public class TestGetInsightsForMissedBills extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForMissedBills.class);
	...
	String accountEntitySchema = "MissedBills.json";
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetMissedBills.csv")
	public void testGetNotificationsForMissedBills(String testCaseId, String testCaseDescription,
			...
			String entityParameterName,String thresholdNameValueType, String numberOfDays,  String numberOfInsights, String editSubscription,
		...
		if (Boolean.parseBoolean(editSubscription)) {
			...
			List<String> itemAccountsList = entityIdsMap.values().stream().collect(Collectors.toList());
			for(String itemAccount : itemAccountsList) {
				insightsDBUtils.updateBillData(itemAccount, numberOfDays);
			}
