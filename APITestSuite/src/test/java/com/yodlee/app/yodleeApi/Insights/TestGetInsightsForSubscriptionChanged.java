...
public class TestGetInsightsForSubscriptionChanged extends Base {
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("SubChanged");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\SubscriptionChanged\\GetSubscriptionChanged.csv")
	...
	public void prepareAutomationReport() throws Exception {
		...
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary, "GET  SubChanged Insight", testInfo);
