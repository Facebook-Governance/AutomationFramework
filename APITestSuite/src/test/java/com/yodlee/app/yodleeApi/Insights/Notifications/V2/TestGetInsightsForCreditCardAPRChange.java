...
public class TestGetInsightsForCreditCardAPRChange extends Base {
	...
	String accountEntitySchema = "CreditCardAprChange.json";
	InsightsUtilV1 insightsUtilsV2 = new InsightsUtilV1();
	
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Low Balance Warning Insight");
	    ...
	    userInfo.setUsername("CardAPRChange" + System.currentTimeMillis());
		...
		Response response = providerAccountUtils.addProviderAccountStrict(providerId, "fieldarray",
				"CreditCardAPR.site16441.1", "site16441.1", sessionObj);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetCreditCardAPRChangeInsight.csv")
	public void testGetNotificationsForCreditCardAPRChange(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String thresholdNameValueType,String noumberOfInsights,String editSubscription
			,String isCobrandSubscribed,String isUserSubscribed,String patchEntityIds,String expectedInsightsForPatchedIds,String expectedNumberOfPatchedInsights,String validateKeys,String updateCredentials,String expectedStatus,String tcEnabled) throws Exception {
