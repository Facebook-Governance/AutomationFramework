...
public class TestGetInsightsForNewSalary extends Base {
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("NewSalary" + System.currentTimeMillis());
	...
	@Source("\\TestData\\CSVFiles\\Insights\\NewSalary\\GetNewSalaryInsight.csv")
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  NewSalary Insight",testInfo);		
