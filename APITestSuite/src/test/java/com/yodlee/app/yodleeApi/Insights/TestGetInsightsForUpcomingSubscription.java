...
public class TestGetInsightsForUpcomingSubscription extends Base {
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("UpcomingSubscription" + System.currentTimeMillis());
	...
	@Source("\\TestData\\CSVFiles\\Insights\\UpcomingSubscription\\GetUpcomingSubscriptionInsight.csv")
	public void testGetNotificationsForUpcomingSubscription(String testCaseId,String testCaseDescription,String insightName,String verifyTriggerCheck,
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  upcomingSubScription Insight",testInfo);		
