...
public class TestGetInsightsForChangeInNetworth extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForChangeInNetworth.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Change in Networth Insight");
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("NETWORTH CHANGE");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetChangeInNetworth.csv")
	public void testGetNotificationsForChangeInNetworth(String testCaseId,
