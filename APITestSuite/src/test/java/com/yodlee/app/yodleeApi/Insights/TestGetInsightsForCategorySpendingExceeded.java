...
public class TestGetInsightsForCategorySpendingExceeded extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForCategorySpendingExceeded.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("catSpendExceeded" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("CategorySpendingExceeded");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\CategorySpendingExceeded\\GetCategorySpendingExceededInsight.csv")
	public void testGetNotificationsForCategorySpendingExceeded(String testCaseId,String testCaseDescription,String insightName,String triggerType,String entityParamsCount,String entityParameterName,String thresholdNameValueType,String noumberOfInsights,String editSubscription
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  CategorySpendingExceeded Insight",testInfo);		
