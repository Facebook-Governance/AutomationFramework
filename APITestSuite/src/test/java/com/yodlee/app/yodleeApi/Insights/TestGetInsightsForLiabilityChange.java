...
public class TestGetInsightsForLiabilityChange extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForLiabilityChange.class);
	...
	public void setUp(String credentials) throws Exception {
	    ...
	    userInfo.setUsername("NetworthChange" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("NetWorthChange");
		automationTestResults.setBuildNo("168");
		automationTestResults.setCodeCoveragePercent("78");
		automationTestResults.setStoryId("B-58743");
				
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\ChangeInLiability\\GetLiabilityChangeInsight.csv")
	public void testGetNotificationsForLiabilityChange(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,
