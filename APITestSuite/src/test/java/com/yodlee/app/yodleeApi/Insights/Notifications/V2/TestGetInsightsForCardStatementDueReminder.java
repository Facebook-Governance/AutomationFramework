...
import com.yodlee.app.yodleeApi.Insights.Notifications.V2.TestGetInsightsForLargeDepositNotice;
...
public class TestGetInsightsForCardStatementDueReminder extends Base {
	...
	String viewEntitySchema = "CardPaymentDueReminderViewEntity.json";
	String accountEntitySchema = "CardPaymentDueReminderAccountEntity.json";
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetCardStatementDueReminderInsight.csv")
