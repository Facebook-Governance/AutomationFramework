...
public class TestGetInsightsForInvestmentMaturityNotice extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForInvestmentMaturityNotice.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("InvestmentMatNotice" + System.currentTimeMillis());
		...
		"InvestMatNotice.site16441.2", "site16441.2", sessionObj);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\InvestmentMaturityNotice\\GetInvestmentMaturityNoticeInsight.csv")
	public void testGetNotificationsForInvestmentMaturityNotice(String testCaseId,String testCaseDescription,String insightName,String triggerType,String entityParamsCount,String entityParameterName,String thresholdNameValueType,String noumberOfInsights,String editSubscription
			,String isCobrandSubscribed,String isUserSubscribed,String noOfDays,String patchEntityIds,String expectedInsightsForPatchedIds,String expectedNumberOfPatchedInsights,String validateKeys,String expectedStatus,String tcEnabled) throws ParseException, InterruptedException, IOException {
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  InvestmentMaturityNotice Insight",testInfo);		
