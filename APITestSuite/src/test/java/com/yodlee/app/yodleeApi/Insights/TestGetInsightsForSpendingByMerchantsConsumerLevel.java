...
public class TestGetInsightsForSpendingByMerchantsConsumerLevel extends Base {
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("SpendingByMerchantsConsumerLevel");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\SpendingByMerchantsConsumerLevel\\GetSpeMerAllAcctsInsight.csv")
	public void testGetNotificationsForSpendingByMerchantsConsumerLevel(String testCaseId, String testCaseDescription,
	...
	private void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("TopMerchantsAllAcct" + System.currentTimeMillis());
	...
	public void prepareAutomationReport() throws Exception {
		...
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,
				"GET SpendingByMerchantsConsumerLevel Insight", testInfo);
