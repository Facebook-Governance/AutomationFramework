...
public class TestGetInsightsForBillNotPaid extends Base {
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("BillNotPaid" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("BillNotPaid");
		automationTestResults.setBuildNo("168");
		automationTestResults.setCodeCoveragePercent("78");
		automationTestResults.setStoryId("B-60426");
	}


	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\BillNotPaid\\GetBillNotPaidInsight.csv")
	public void testGetNotificationsForBillNotPaid(String testCaseId,String testCaseDescription,String insightName,String verifyTriggerCheck,
			...
			String viewRuleAmountRangeDetails,String viewRuleCategoryIdDetails,String viewRuleMerchantTypeDetails,String noOfDays,String expectedStatus,String tcEnabled) throws ParseException, InterruptedException, IOException {
