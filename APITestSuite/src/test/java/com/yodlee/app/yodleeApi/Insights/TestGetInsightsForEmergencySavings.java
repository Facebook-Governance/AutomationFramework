...
public class TestGetInsightsForEmergencySavings extends Base {
	...
	String expTotalAvailableBalance = null;
	String expAverageSpendingAmt = null;
	String expSpendingRunWay = null;
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setStoryId("B-67204");
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\EmergencySavings\\GetEmergencySavingsInsight.csv")
	public void testGetNotificationsForEmergencySavings(String testCaseId, String testCaseDescription,
			...
			String isCobrandSubscribed, String isUserSubscribed, String accountName, String patchEntityIds,
			String expectedInsightsForPatchedIds, String expectedNumberOfPatchedInsights,
			String csvExpTotalAvailableBalance, String csvExpAverageSpendingAmt, String csvExpSpendingRunWay,
		...
		setExpectedData(testCaseId, csvExpTotalAvailableBalance, csvExpAverageSpendingAmt, csvExpSpendingRunWay);
		...
		if (commonEntity.getExpectedResultValues().getTestNotificationStatus()) {
			...
			if (!numberOfInsights.equals("0"))
				commonEntity = validateInsights.verifyData_emergencySavingsInsight(userInsightsResponse, commonEntity,
						expTotalAvailableBalance, expAverageSpendingAmt, expSpendingRunWay);
		}
	...
	private void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("EmergencySavings" + System.currentTimeMillis());
	...
	private void setExpectedData(String tcId, String csvExpTotalAvailableBalance, String csvExpAverageSpendingAmt,
			String csvExpSpendingRunWay) {
		if (tcId.equals("AT-169107")) {
			expTotalAvailableBalance = csvExpTotalAvailableBalance;
			expAverageSpendingAmt = csvExpAverageSpendingAmt;
			expSpendingRunWay = "0.60";
		} else if (tcId.equals("AT-169108")) {
			expTotalAvailableBalance = csvExpTotalAvailableBalance;
			expAverageSpendingAmt = csvExpAverageSpendingAmt;
			expSpendingRunWay = csvExpSpendingRunWay;
		} else if (tcId.equals("AT-169109")) {
			expTotalAvailableBalance = "7000.00";
			expAverageSpendingAmt = csvExpAverageSpendingAmt;
			expSpendingRunWay = csvExpSpendingRunWay;
		} else if (tcId.equals("AT-169112")) {
			expTotalAvailableBalance = csvExpTotalAvailableBalance;
			expAverageSpendingAmt = csvExpAverageSpendingAmt;
			expSpendingRunWay = csvExpSpendingRunWay;
		} else if (tcId.equals("AT-169113")) {
			expTotalAvailableBalance = "0.00";
			expAverageSpendingAmt = csvExpAverageSpendingAmt;
			expSpendingRunWay = "0.00";
		} else if (tcId.equals("AT-169115")) {
			expTotalAvailableBalance = csvExpTotalAvailableBalance;
			expAverageSpendingAmt = csvExpAverageSpendingAmt;
			expSpendingRunWay = csvExpSpendingRunWay;
		} else if (tcId.equals("AT-169116")) {
			expTotalAvailableBalance = "0.00";
			expAverageSpendingAmt = csvExpAverageSpendingAmt;
			expSpendingRunWay = "0.00";
		} else if (tcId.equals("AT-169117")) {
			expTotalAvailableBalance = "0.00";
			expAverageSpendingAmt = csvExpAverageSpendingAmt;
			expSpendingRunWay = "0.00";
		} else if (tcId.equals("AT-169118")) {
			expTotalAvailableBalance = "5000.00";
			expAverageSpendingAmt = csvExpAverageSpendingAmt;
			expSpendingRunWay = csvExpSpendingRunWay;
		}
	}
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary, "GET EmergencySavings Insight",
				testInfo);
