...
public class TestCreateUserSegment extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestCreateUserSegment.class);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\CreateUserSegment.csv")
	public void testCreateUserSegment(String testCaseId,String testCaseDescription,String income,String incomeCurrency,String incomeRange,String city,
