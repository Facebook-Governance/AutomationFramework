...
public class TestGetInsightsForProjectedLowBalance extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForProjectedLowBalance.class);
	...
	String accountEntitySchema = "ProjectedLowBalanceAccountEntity.json";
	...
	public void setUp() throws Exception {
		...
		"ProjectedLowBalance.bank1", "bank1", sessionObj);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetProjectedLowBalanceInsight.csv")
	public void testGetNotificationsForTestGetInsightsForProjectedLowBalance(String testCaseId,String testCaseDescription,String insightName,String triggerType,String entityParamsCount,String entityParameterName,String thresholdNameValueType,String noumberOfInsights,String editSubscription
