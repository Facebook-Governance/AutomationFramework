...
public class TestGetInsightsForAggregateCreditCardAccount extends Base {
	...
	String accountEntity ="AggregateCreditCardAccount.json";
	String accountEntity1 ="AggregateCreditCardAccount1.json";
	
	public void setUp(String credentials) throws Exception {
		System.out.println("Initiated execution for Aggregate Credit Card Account Insight");
	    ...
	    userInfo.setUsername("AggreAccount" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("TestGetInsightsForAggregateCreditCardAccount");
		automationTestResults.setBuildNo(buildNo);
		automationTestResults.setCodeCoveragePercent(codeCoverage);
		automationTestResults.setStoryId("B-66650");
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetAggregateCreditCardAccountInsight.csv")
	public void testGetNotificationsForAggregateCreditCardAccount(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String noumberOfInsights,String editSubscription
		...
		if(testCaseId.equals("AT-143988")){
			accountEntity=accountEntity1;
		}
		Boolean noInsightGenerated=false;
		if(!testCaseId.equals("AT-143983")){
		setUp(credentials);
		}
		...
		if(!noInsightGenerated){
			...
			if(expectedResultValues.isUserPatched() && expectedResultValues.getCobrandSubscribed()) {	
				...
				for(int i=0;i<entities.size();i++) {					
					...
					commonEntity = validateInsights.verifyGeneratedInsightsForPatchedEntitesV2(userInsightsResponse,expectedResultValues,commonEntity,expNoOfInsights,thresholdValue,accountEntity,"");
			...
			if(commonEntity.getExpectedResultValues().getTestNotificationStatus()) {
				...
				httpParams.setHttpMethod("GET");
				userInsightsResponse = insightsUtilsV2.getInsightsFeeds(httpParams, null);
				commonEntity = validateInsights.verifyGeneratedInsightsV2(userInsightsResponse,expectedResultValues,commonEntity,Boolean.parseBoolean(isUserSubscribed),accountEntity,"");;		
			}
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  AggregateCreditCardAccount Insight",testInfo);		
