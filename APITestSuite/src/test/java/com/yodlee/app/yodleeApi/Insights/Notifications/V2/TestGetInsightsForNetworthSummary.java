...
public class TestGetInsightsForNetworthSummary extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForNetworthSummary.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Networth Summary Insight");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetNetworthSummary.csv")
	public void testGetNotificationsForNetworthSummary(String testCaseId, String testCaseDescription,
	...
	public void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("NWS" + System.currentTimeMillis());
