...
public class TestGetInsightsForCreditUtilization extends Base {
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForCreditUtilization.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("CreditUtilize" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("CrediLimitWarning");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\CreditUtilization1\\GetCreditUtilizationInsight.csv")
