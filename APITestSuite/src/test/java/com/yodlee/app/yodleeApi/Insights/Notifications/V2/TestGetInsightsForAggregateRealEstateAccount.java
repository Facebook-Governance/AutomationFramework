...
public class TestGetInsightsForAggregateRealEstateAccount extends Base {
	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForAggregateRealEstateAccount.class);
	...
	String accountEntity ="AggregateRealEstateAccount.json";
	
	public void setUp(String credentials) throws Exception {
		System.out.println("Initiated execution for Aggregate Real Estate Account Insight");
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("TestGetInsightsForAggregateRealEstateAccount");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetAggregateRealEstateAccountInsight.csv")
	public void testGetNotificationsForAggregateRealEstateAccount(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String noumberOfInsights,String editSubscription
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  AggregateRealEstateAccount Insight",testInfo);		
