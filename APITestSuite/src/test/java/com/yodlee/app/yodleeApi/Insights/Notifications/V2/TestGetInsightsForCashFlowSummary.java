...
public class TestGetInsightsForCashFlowSummary extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForCashFlowSummary.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Cash Flow Summary Insight");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetCashFlowSummaryInsight.csv")
	public void testGetNotificationsForCashFlowSummary(String testCaseId, String testCaseDescription,
