...
public class TestGetInsightsForCreditCardAPRChange extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForCreditCardAPRChange.class);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\CreditCardAPRChange\\GetCreditCardAPRChangeInsight.csv")
