...
public class TestGetInsightsForGoalsCompleted extends Base {
	
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForGoalsCompleted.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("GoalCompleted" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {	
		...
		automationTestResults.setInsights("GoalCompleted");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\GoalCompleted\\GetGoalCompletedInsight.csv")
	public void testGetNotificationsForGoalCompleted(String testCaseId,String testCaseDescription,String insightName,String supportedContainers,String triggerType,String goalName,
		...
		if(expectedResultValues.isUserPatched() && expectedResultValues.getCobrandSubscribed()) {	
				...
				for(int i=0;i<entities.size();i++) {					
					...
					int expNoOfInsights =  entities.get(i).isSubscribed() && goalStatus.split(",")[i].equals("COMPLETED") && entitySubscriptionMap.get(patchedEntityId)?1:0;
