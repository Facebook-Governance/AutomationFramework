...
public class TestGetInsightsForAggregateCreditCardAccount extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForAggregateCreditCardAccount.class);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\AggregateCreditCardAccount\\GetAggregateCreditCardAccountInsight.csv")
