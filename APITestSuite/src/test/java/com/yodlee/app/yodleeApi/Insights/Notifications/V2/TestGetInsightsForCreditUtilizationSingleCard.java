...
public class TestGetInsightsForCreditUtilizationSingleCard extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForCreditUtilizationSingleCard.class);
	...
	String accountEntitySchema = "CreditUtilizationSingleCardAccountEntitySchema.json";
	...
	public void setUp() throws Exception {
		...
		userInfo.setUsername("CreditUtilizationSingleCardV2" + System.currentTimeMillis());
		// userInfo.setUsername("climit2"); //sense user and wellness
		...
		Response response = providerAccountUtils.addProviderAccountStrict(providerId, "fieldarray",
				"creditLimitWarning.site16441.1", "site16441.1", sessionObj);
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("CrediLimitWarningV2");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetCreditUtilizationSingleCardInsight.csv")
	public void testGetNotificationsForCreditLimitWarning(String testCaseId, String testCaseDescription,
			String insightName, String triggerCheckEnabled, String triggerType, String entityParamsCount,
			String entityParameterName, String thresholdNameValueType, String noumberOfInsights,
			String editSubscription, String isCobrandSubscribed, String isUserSubscribed, String patchEntityIds,
		...
		if (Boolean.parseBoolean(editSubscription)) {
				...
				try {
					if (!isCobrandSubscribed.equals("NA")) {
						String patchCobSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(
								...
								thresholdNameValueType, "", "", editSubscription, isCobrandSubscribed, "",
								entityIdsMap);
			...
			if (!isUserSubscribed.isEmpty()) {
				String patchUserSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(
						...
						thresholdNameValueType, "", "", editSubscription, isUserSubscribed, patchEntityIds,
						entityIdsMap);
		...
		expectedResultValues = insightsGenerics.getExpectedAttributesToBeValidatedV2(testCaseId, insightName,
				...
				numberOfKeys, insightsCommons.getCobrandSubscriptionMap(entityParameterName, isCobrandSubscribed),
		...
		if (expectedResultValues.isUserPatched() && expectedResultValues.getCobrandSubscribed()) {
			...
			for (int i = 0; i < entities.size(); i++) {
				...
				commonEntity = validateInsights.verifyGeneratedInsightsForPatchedEntitesV2(userInsightsResponse,
						expectedResultValues, commonEntity, expNoOfInsights, thresholdValue, accountEntitySchema, "");
