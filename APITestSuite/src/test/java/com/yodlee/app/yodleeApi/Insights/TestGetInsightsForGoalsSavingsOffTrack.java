...
public class TestGetInsightsForGoalsSavingsOffTrack extends Base {
	
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForGoalsSavingsOffTrack.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("GoalOffTrack" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {	
		...
		automationTestResults.setInsights("GoalOffTrack");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\GoalSavingsOffTrack\\GetGoalSavingsOffTrack.csv")
	public void testGetNotificationsForGoalSavingsOffTrack(String testCaseId,String testCaseDescription,String insightName,String supportedContainers,String triggerType,String goalName,
	...
	public void deleteCreatedGoalsForUser(ArrayList<String> deleteGoalsList,HashMap<String,String> goalsMap) {
		HttpMethodParameters httpParams = HttpMethodParameters.builder().build();
		if(commonEntity.getExpectedResultValues().getTestCaseId().equals("AT-147347"))
			System.out.println("check...............");
		for(int i =0 ;i<deleteGoalsList.size();i++) {
			LinkedHashMap<String, Object> pathParam =new LinkedHashMap<>(); 
			pathParam.put("goalIdDelete", Long.parseLong(goalsMap.get(deleteGoalsList.get(i))));			
			httpParams.setPathParams(pathParam);
			Response deleteResponse=sfgUtils.deleteGoal(httpParams, sessionObj);
			entityIdsMap.remove(goalList.get(i));
			deleteGoalsList.remove(i);
		}
