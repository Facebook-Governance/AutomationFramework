...
public class TestGetInsightsForMostFrequentPurchasesAllAccounts extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForMostFrequentPurchasesAllAccounts.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Count of Transactions By Merchant All Accounts Insight");
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("Count of Transactions By Merchant All Accounts");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetMostFrequentPurchasesAllAccountsInsight.csv")
	...
	public void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("MostFrePurAll" + System.currentTimeMillis());
