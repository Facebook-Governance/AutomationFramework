...
public class TestGetInsightsForLoanMaturityNotice extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForLoanMaturityNotice.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("loanMatNotice" + System.currentTimeMillis());
		...
		"LoanMaturityNotice.site16441.1", "site16441.1", sessionObj);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\LoanMaturityNotice\\GetLoanMaturityNoticeInsight.csv")
	public void testGetNotificationsForLoanMaturityNotice(String testCaseId,String testCaseDescription,String insightName,String triggerType,String entityParamsCount,String entityParameterName,String thresholdNameValueType,String noumberOfInsights,String editSubscription
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  LoanMaturityNotice Insight",testInfo);		
