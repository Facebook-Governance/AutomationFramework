...
public class TestGetInsightsForNewSalary extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForNewSalary.class);
	...
	String accountEntitySchema = "NewSalaryAccountEntitySchema.json";
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("NewSalaryV2");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetNewSalaryInsight.csv")
	public void testGetNotificationsForNewSalary(String testCaseId,String testCaseDescription,String insightName,String verifyTriggerCheck,
			String triggerType,String viewsAndAccountInsightsCount,String entityParamsCount,String entityParameterName,String numberOfInsights,String editSubscription
		...
		expectedResultValues = insightsGenerics.getExpectedAttributesToBeValidatedV2(testCaseId, insightName, triggerType, "OTHER", entityParameterName, "", Integer.parseInt(numberOfInsights), numberOfKeys, 
