...
public class TestGetInsightsForCameinUnderBudget extends Base {
	...
	public void setUp() throws Exception {	
	    ...
	    userInfo.setUsername("CameInUndBud" + System.currentTimeMillis());
		...
		Response response1 = providerAccountUtils.addProviderAccountStrict(providerId, "fieldarray",
				"cameinunderbudget.site16441.2", "site16441.2", sessionObj);
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("CameInUnderBudget");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\CameinUnderBudget\\GetCameinUnderBudgetInsight.csv")
	public void testGetNotificationsForCameinUnderBudget(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String accountGroupName,
