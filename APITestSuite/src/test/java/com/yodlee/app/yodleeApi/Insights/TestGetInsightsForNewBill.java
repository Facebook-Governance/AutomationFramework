...
public class TestGetInsightsForNewBill extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForNewBill.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("NewBill" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("NewBill");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\NewBillEventDetected\\GetNewBillInsight.csv")
	public void testGetNotificationsForNewBill(String testCaseId,String testCaseDescription,String insightName,String verifyTriggerCheck,
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  NewBill Insight",testInfo);		
