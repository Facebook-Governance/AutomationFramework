...
public class TestGetInsightsForLowBalanceWarning extends Base {
	...
	String accountEntitySchema = "LowBalanceWarning.json";
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("GetLowBalWarn" + System.currentTimeMillis());
		...
		"lbwinsight.site16441.1", "site16441.1", sessionObj);
		...
		String accountEntity ="RefundDepositAccountEntity.json";
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetLowBalanceWarningInsight.csv")
	public void testGetNotificationsForLowBalanceWarning(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String thresholdNameValueType,String noumberOfInsights,String editSubscription
