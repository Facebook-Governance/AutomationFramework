...
import com.yodlee.app.yodleeApi.Insights.TestGetInsightsForCategorySpendingExceeded;
...
public class TestGetInsightsForSpendingExceededAverage extends Base {
	...
	String accountEntitySchema = "SpendingExceededAverageAccountEntitySchema.json";
	
	
	
	@BeforeClass(alwaysRun = true)
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Spending Exceeded Average Insight");
	    ...
	    userInfo.setUsername("GetSpendExcAvg" + System.currentTimeMillis());
		...
		"catSpendExc.site16441.1", "site16441.1", sessionObj);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetSpendingExceededAverage.csv")
	public void testGetNotificationsForCategorySpendingExceeded(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String thresholdNameValueType,String noumberOfInsights,String editSubscription
			,String isCobrandSubscribed,String isUserSubscribed,String patchEntityIds,String expectedInsightsForPatchedIds,String expectedNumberOfPatchedInsights,String validateKeys,String expectedStatus,String tcEnabled) throws ParseException, InterruptedException, IOException {
		...
		if (Boolean.parseBoolean(editSubscription)) {
			if (!isCobrandSubscribed.isEmpty()) {		
				try {					
					if(!isCobrandSubscribed.equals("NA")) {
						...
						String patchCobSubscriptionBodyParam = insightsCommons.constructPatchSubscriptionRequestForCustomerAndUser(InsightsConstants.COB_SUBSCRIPTION_CONTEXT,insightName,"","","","","","",entityParameterName,thresholdNameValueType,"","",isCobrandSubscribed,"",null,editSubscription);
			...
			if (!isUserSubscribed.isEmpty()) {    
				String patchUserSubscriptionBodyParam = insightsCommons.constructPatchSubscriptionRequestForCustomerAndUser(InsightsConstants.USER_SUBSCRIPTION_CONTEXT,insightName,"","","","","","",entityParameterName,thresholdNameValueType,"","",isUserSubscribed,patchEntityIds,entityIdsMap,editSubscription);
