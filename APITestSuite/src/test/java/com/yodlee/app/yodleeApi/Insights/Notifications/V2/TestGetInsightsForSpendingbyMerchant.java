...
public class TestGetInsightsForSpendingbyMerchant extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForSpendingbyMerchant.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Spending By Merchant Insight");
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("SpendingbyMerchant");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetSpendingbyMerchantInsight.csv")
	public void testGetNotificationsForSpendingbyMerchant(String testCaseId, String testCaseDescription, String insightName,
			String verifyTriggerCheck, String triggerCheckEnabled, String supportedContainers, String inputContainers,
			...
			String isCobrandSubscribed, String isUserSubscribed, String schema, String duration, String frequency,
			String entityDetails, String accountStatus, String patchEntityIds, String validateKeys, String viewsRules,
			String viewRuleAccountNames, String viewRuleTransctionIDs, String viewRuleAmountRange,
			String viewRuleCategoryIds, String expectedStatus, String tcEnabled)
		...
		if (Boolean.parseBoolean(editSubscription)) {
			...
			if (entityParameterName.equalsIgnoreCase("view")) {
				String patchUserSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(
						InsightsConstants.USER_SUBSCRIPTION_CONTEXT, insightName, "account", "", "", duration,
		...
		if (!patchEntityIds.isEmpty() || !entityDetails.isEmpty()) {
			String[] entityItems = patchEntityIds.split("\\s+");
			entityItems = entityDetails.split("\\s+");
		...
		insightsGenerics.setViewsPropertiesDetails("", "", viewRuleAmountRange, "", "", "", commonEntity);
	...
	public void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("SpendingMerchant" + System.currentTimeMillis());
