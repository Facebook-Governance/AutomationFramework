...
public class TestGetInsightsForCardStatementAvailable extends Base {
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForCardStatementAvailable.class);
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("CardStatementAvailable");
		automationTestResults.setBuildNo("350");
		automationTestResults.setCodeCoveragePercent("78");
		automationTestResults.setStoryId("B-63176");	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\CardStatementAvailable\\GetCardStatementAvailableInsight.csv")
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  CardStatementAvailable Insight",testInfo);
