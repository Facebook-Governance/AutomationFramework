...
import com.yodlee.yodleeApi.helper.*;
...
public class TestGetInsightsForBalanceAboveThreshold extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForBalanceAboveThreshold.class);
	...
	String accountEntitySchema = "BalanceAboveThreshold.json";
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Balance Above Threshold Insight");
	    ...
	    userInfo.setUsername("BalAboveTh" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("BalanceAboveThreshold");
		automationTestResults.setBuildNo("168");
		automationTestResults.setCodeCoveragePercent("78");
		automationTestResults.setStoryId("B-51206");
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetBalanceAboveThresholdInsight.csv")
	public void testGetNotificationsForBalanceAboveThreshold(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,
