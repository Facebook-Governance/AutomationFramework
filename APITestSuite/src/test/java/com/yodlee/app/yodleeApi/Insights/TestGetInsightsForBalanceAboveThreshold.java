...
public class TestGetInsightsForBalanceAboveThreshold extends Base {
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("BalAbTh" + System.currentTimeMillis());
	...
	@Source("\\TestData\\CSVFiles\\Insights\\BalanceAboveThreshold\\GetBalanceAboveThresholdInsight.csv")
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  BalanceAboveThreshold Insight",testInfo);		
