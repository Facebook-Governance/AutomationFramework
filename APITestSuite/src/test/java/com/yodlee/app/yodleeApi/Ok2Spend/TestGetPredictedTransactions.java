 ...
 *
 */
public class TestGetPredictedTransactions extends Base {
	...
	@Source("\\TestData\\CSVFiles\\Ok2Spend_EndPoint\\GetPredictedTransaction.csv")
	public void testGetPredictedTransactions(String testCaseId, String testcaseName, String fromDate, String toDate,
		...
		if(bothCardBank.contains("bank,creditCard")){
			...
			if(testcaseName.contains("without container")){
				mapQueryParams = senseTransactionsHelper.createInputForGetAllTransactions(fromDate,
						toDate, container, baseType, keyword, null, null, sourceType, type, categoryId, categoryType,
						skip, top);
		...
		System.out.println("getTransactionResponse from testGetTransactions() " + getTransactionResponse.toString());
	...
	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Ok2Spend_EndPoint\\GetPredictedTransactionSingle.csv")
	public void testGetPredictedTransactionForSingle(String testCaseId, String testcaseName, String fromDate, String toDate,
			String container, String baseType, String keyword, String accountId,String bothCardBank,String seriesId, String sourceType,
			String categoryId, String type, String categoryType, String skip, String top, int httpStatusCode,
		...
		if (testcaseName.contains("predictedTransactionId")){
			...
			System.out.println("getTransactionResponse from testGetTransactions() " + getTransactionResponse.asString());
		...
		else if (testcaseName.contains("predictedEventId")){
