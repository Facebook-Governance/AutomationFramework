...
public class TestGetInsightsForLargeDepositNotice extends Base {
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("LargeDepositNotice" + System.currentTimeMillis());
		//userInfo.setUsername("cardstmtdue911"); //sense user and wellness
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("LargeDepositNotice");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\LargeDepositNotice\\GetLargeDepositNoticeInsight.csv")
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  LargeDepositNotice Insight",testInfo);		
