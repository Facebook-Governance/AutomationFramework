...
public class TestGetInsightsForUpcomingBills extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForUpcomingBills.class);
	...
	String accountEntitySchema = "UpcomingBillsAccountSchema.json";
	String viewEntitySchema = "UpcomingBillsViewSchema.json";
	
	
	@BeforeClass(alwaysRun = true)
	public void setUp() throws Exception {
		System.out.println("Initiated execution for UpComing Bills Insight");
	    ...
	    userInfo.setUsername("UpcomingBills" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("UpcomingBills");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetUpcomingBillsInsight.csv")
	public void testGetNotificationsForUpcomingBills(String testCaseId,String testCaseDescription,String insightName,String verifyTriggerCheck,
			...
			String viewRuleAmountRangeDetails,String viewRuleCategoryIdDetails,String viewRuleMerchantTypeDetails,String frequency,String expectedStatus,String tcEnabled) throws ParseException, InterruptedException, IOException {
		...
		if (Boolean.parseBoolean(editSubscription)) {
			if (!isCobrandSubscribed.isEmpty()) {		
				try {					
					if(!isCobrandSubscribed.equals("NA")) {
						String patchCobSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(InsightsConstants.COB_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,thresholdNameValueType,frequency,"",editSubscription,isCobrandSubscribed,"",entityIdsMap);
			...
			if (!isUserSubscribed.isEmpty()) {    
				String patchUserSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(InsightsConstants.USER_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,thresholdNameValueType,frequency,"",editSubscription,isUserSubscribed,patchEntityIds,entityIdsMap);
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  upcomingBills Insight",testInfo);		
