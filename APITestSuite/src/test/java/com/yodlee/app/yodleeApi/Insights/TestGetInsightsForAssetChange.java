...
public class TestGetInsightsForAssetChange extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForAssetChange.class);
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("AssetChange");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\ChangeInAsset\\GetAssetChangeInsight.csv")
	public void testGetNotificationsForAssetChange(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,
