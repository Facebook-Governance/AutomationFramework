...
public class TestGetInsightsForAggregateMortgageAccount extends Base {
	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForAggregateMortgageAccount.class);
	...
	String accountEntity ="AggregateMortgageAccount.json";
	
	public void setUp(String credentials) throws Exception {
		System.out.println("Initiated execution for Aggregate Mortgage Account Insight");
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("TestGetInsightsForAggregateMortgageAccount");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetAggregateMortgageAccountInsight.csv")
	public void testGetNotificationsForAggregateMortgageAccount(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String noumberOfInsights,String editSubscription
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  AggregateMortgageAccount Insight",testInfo);		
