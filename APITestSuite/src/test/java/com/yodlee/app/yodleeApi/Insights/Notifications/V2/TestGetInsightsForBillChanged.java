...
public class TestGetInsightsForBillChanged extends Base {
	...
	String viewEntitySchema = "BillChangedViewEntitySchema.json";
	String accountEntitySchema = "BillChangedAccountEntitySchema.json";
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("BillAmtChangedV2" + System.currentTimeMillis());
	...
	public void addAccounts(String dagUserName,String dagPassWord) throws Exception {
		...
		envUser = (configurationObj.getApiVersion().equals("1.1") ? user
				: (configurationObj.getApiVersion().equals("2") ? user.substring(0, user.length() - 2) : null));	
		User userInfo = User.builder().build();
	    userInfo.setUsername("BillChangedV2" + System.currentTimeMillis());
		loginUser = userInfo.getUsername();
		automationTestResults.setUserName(loginUser);
		System.out.println("User ----> "+userInfo.getUsername());
		userInfo.setPassword("TEST@123");
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("BillChangedV2");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetBillChanged.csv")
