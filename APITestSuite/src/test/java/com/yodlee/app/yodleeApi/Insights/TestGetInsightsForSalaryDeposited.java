...
public class TestGetInsightsForSalaryDeposited extends Base {
	...
	String jwtCobAuthToken = "Bearer eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJhM2E2MWMwYS1hYjlmLWVlNzktMWY2Zi02ZTAwYjM5NzQzOGMiLCJzdWIiOiJJbnNpZ2h0c0VuZ2luZXVzZXJzMjgiLCJjb2JyYW5kSWQiOiIxMDAwMDAwNCIsImlhdCI6MTU4ODQ0MjA3MCwiZXhwIjoxNTg4NDQ1MDcwfQ.CCwJt4OLCNLjSpW6-ZhN4w3VXOdvivy9JyqoSQ0u2OsdfJbALGpY2ufn6rwWTS2zjCL-zeompLZLjjNGf2K5T8tBG32gRJ_etmCV4Q5xhSbLTzT_mLA4EIpYo2Djk3shuQfG8l0OZruJy6wW0bIdFlM8zcOpd7b2XDXwNJXJOeYGF-ZCkk73ywDIYefCAapyctmgNLc0ojg5Jq7D9waxg5_0VYlTHeVCBLlFhVN-hvgmKkREpOMz4icVL7_CgaP2-xcnPALAcY_lw4hsfVHRyEsvTEuIRZWMWbnz40pMNfIA3hHhDO-TKLUAPGh6FQr-5zjEijnKJTdbRXeoYAXC9A";
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForSalaryDeposited.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("GetSalDeposit" + System.currentTimeMillis());
	...
	public void addAccounts(String dagUserName,String dagPassWord) throws Exception {
		...
		envUser=prop.readPropertiesFile().getProperty("envUser");		
		User userInfo = User.builder().build();
	    userInfo.setUsername("SalDeposit" + System.currentTimeMillis());
		loginUser = userInfo.getUsername();
		automationTestResults.setUserName(loginUser);
		System.out.println("User ----> "+userInfo.getUsername());
		userInfo.setPassword("TEST@123");
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("SalaryDeposited");
		automationTestResults.setBuildNo("274");
		automationTestResults.setCodeCoveragePercent("78");
		automationTestResults.setStoryId("B-60402");
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\SalDeposited\\GetSalaryDepositedInsight.csv")
	public void testGetNotificationsForSalaryDeposited(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,
			...
			,String isCobrandSubscribed,String isUserSubscribed,String dagCredentials,String updateCredentials,String patchEntityIds,String expectedInsightsForPatchedIds,String expectedNumberOfPatchedInsights,String validateKeys,String expectedStatus,String tcEnabled) throws Exception {
