...
public class TestGetInsightsForSpendingEarningComparison extends Base {
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setStoryId("B-66956");
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\SpendingEarningComparison\\GetSpendingEarningInsight.csv")
	public void testGetNotificationsForSpendingEarningComparison(String testCaseId, String testCaseDescription,
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary, "GET SpendingEarningComparison Insight",
				testInfo);
