...
public class TestGetInsightsForAggregateSavingsCheckingAccount extends Base {
	...
	String accountEntity ="AggregateSavingsCheckingAccount.json";
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("TestGetInsightsForAggregateSavingsCheckingAccount");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetAggregateSavingsCheckingAccountInsight.csv")
	public void testGetNotificationsForAggregateSavingsCheckingAccount(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String noumberOfInsights,String editSubscription
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  AggregateSavingsCheckingAccount Insight",testInfo);		
