...
public class TestGetInsightsForChangeInLiabilities extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForChangeInLiabilities.class);
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("Liabilities CHANGE");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetChangeInLiabilities.csv")
	public void testGetNotificationsForChangeInLiabilities(String testCaseId,
		...
		if (!schema.isEmpty())
			entitySchema = schema;
		/*
		 * if (duration.isEmpty()) duration = "THREE_MONTHS";
		 */
	...
	public void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("NW" + System.currentTimeMillis());
