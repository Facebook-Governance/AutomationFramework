...
public class TestGetInsightsForSuggestedSavingOpportunity extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForSuggestedSavingOpportunity.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Suggested Saving Opportunity Insight");
		...
		insightsDBUtils.disableCustomerSubscriptions(envCobrand,jwtCobAuthToken,null);	
		 ...
		 /* Gson gson = new Gson();
		  CreateSegment segment = insightsCommons.constructCreateUserSegmentPayload("1000", "USD", "", "HOUSTON", "TX", "USA", "", "", "", "", "TRUE", "STUDENT");
			...
			if(createUserSegmentResponse.getStatusCode()!=201) {
				Assert.fail();
			}*/
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("SuggestedSavingOpportunity");
		automationTestResults.setBuildNo("297");
		automationTestResults.setCodeCoveragePercent("85");
		automationTestResults.setStoryId("B-XXXXX0");
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetSuggestedSavingOpportunity.csv")
	public void testGetNotificationsForSuggestedSavingOpportunity(String testCaseId, String testCaseDescription,
	...
	public void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("SSO" + System.currentTimeMillis());
