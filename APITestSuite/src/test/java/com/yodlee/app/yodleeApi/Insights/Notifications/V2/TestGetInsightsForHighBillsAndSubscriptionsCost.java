...
public class TestGetInsightsForHighBillsAndSubscriptionsCost extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForHighBillsAndSubscriptionsCost.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for High Bills And Subscription Cost Insight");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetHighBillsAndSubscriptionsCostInsight.csv")
	public void testGetNotificationsForHighBillsAndSubscriptionsCostInsight(String testCaseId,
