...
public class TestGetInsightsForIncomeExpenseOverview extends Base {
	...
	String viewEntitySchema = "NetIncomeSummaryViewEntitySchema.json";
	String viewEntitySchema2 = "NetIncomeSummaryViewEntitySchema2.json";
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("NetIncomeSummaryV2" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("NetIncomeSummaryV2");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetIncomeExpenseOverviewInsight.csv")
	public void testGetNotificationsForIncomeExpenseOverview(String testCaseId,String testCaseDescription,String insightName,String verifyTriggerCheck,
		...
		if(testCaseId.equals("AT-148478")) {
			viewEntitySchema=viewEntitySchema2;
		}
		...
		if (Boolean.parseBoolean(editSubscription)) {
			if (!isCobrandSubscribed.isEmpty()) {		
				try {					
					if(!isCobrandSubscribed.equals("NA")) {
						String patchCobSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(InsightsConstants.COB_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,"",frequency,duration,editSubscription,isCobrandSubscribed,"",entityIdsMap);
			...
			if (!isUserSubscribed.isEmpty()) {    
				String patchUserSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(InsightsConstants.USER_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,"",frequency,duration,editSubscription,isUserSubscribed,patchEntityIds,entityIdsMap);
		...
		if(testCaseId.equals("AT-148476")) {
