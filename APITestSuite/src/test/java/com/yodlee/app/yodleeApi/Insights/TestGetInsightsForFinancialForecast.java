...
public class TestGetInsightsForFinancialForecast extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForFinancialForecast.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("GetFinForecast" + System.currentTimeMillis());
		...
		"FinancialForecat.site16441.1", "site16441.1", sessionObj);
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("FinancialForecast");
		automationTestResults.setBuildNo("455");
		automationTestResults.setCodeCoveragePercent("87");
		automationTestResults.setStoryId("B-65293");
				
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\FinancialForecast\\GetFinancialForecastInsight.csv")
	public void testGetNotificationsForFinancialForecast(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,
		...
		if (Boolean.parseBoolean(editSubscription)) {
			if (!isCobrandSubscribed.isEmpty()) {		
				try {					
					if(!isCobrandSubscribed.equals("NA")) {
						String patchCobSubscriptionBodyParam = insightsCommons.constructCobrandandUserPatchRequest(InsightsConstants.COB_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,thresholdNameValueType,frequency,"",editSubscription,isCobrandSubscribed,"",entityIdsMap);
			...
			if (!isUserSubscribed.isEmpty()) {    
				String patchUserSubscriptionBodyParam = insightsCommons.constructCobrandandUserPatchRequest(InsightsConstants.USER_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,thresholdNameValueType,frequency,"",editSubscription,isUserSubscribed,patchEntityIds,entityIdsMap);
