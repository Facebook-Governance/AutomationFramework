...
public class TestGetInsightsForIncomeThresholdInsight extends Base {
	...
	public void setUp() throws Exception {
	   ...
	   // userHelper.getUserSession(userInfo.getUsername(),userInfo.getPassword(),sessionObj)	;	
		...
		"incomeThresold.site16441.1", "site16441.1", sessionObj);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\IncomeThreshold\\GetIncomeThresholdInsight.csv")
	public void testGetNotificationsForIncomeThreshold(String testCaseId,String testCaseDescription,String insightName,String verifyTriggerCheck,
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  IncomeThreshold Insight",testInfo);		
