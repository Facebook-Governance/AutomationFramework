...
public class TestGetInsightsForCategorizeTransactions extends Base {
	...
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForCategorizeTransactions.class);
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("GetCategorizedTxns" + System.currentTimeMillis());
		...
		"categorizetxns.site16441.1", "site16441.1", sessionObj);
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("CategorizeTransactions");
		automationTestResults.setBuildNo("455");
		automationTestResults.setCodeCoveragePercent("87");
		automationTestResults.setStoryId("B-66955");
				
	}

	@Test(enabled = true, dataProvider = "feeder")
	@Source("\\TestData\\CSVFiles\\Insights\\CategorizeTransactions\\GetCategorizeTransactionsInsight.csv")
	public void testGetNotificationsForCategorizeTransactions(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,
			String entityParameterCount,String entityParameterName,String thresholdNameValueType,String duration,String numberOfInsights,String editSubscription,String isCobrandSubscribed,
			String isUserSubscribed,String patchEntityIds,String expectedInsightsForPatchedIds,String expectedNumberOfPatchedInsights,String validateKeys,String expectedStatus,String tcEnabled) throws Exception {
			...
			if (!isCobrandSubscribed.isEmpty()) {		
				try {					
					if(!isCobrandSubscribed.equals("NA")) {
						String patchCobSubscriptionBodyParam = insightsCommons.constructCobrandandUserPatchRequest(InsightsConstants.COB_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,thresholdNameValueType,"",duration,editSubscription,isCobrandSubscribed,"",entityIdsMap);
					...
					isCobrandSubscribed=isCobrandSubscribed.equals("NA")?"TRUE TRUE TRUE TRUE  TRUE TRUE":isCobrandSubscribed;
				}catch(Exception e) {
					e.printStackTrace();
				}
			}
			if (!isUserSubscribed.isEmpty()) {    
				String patchUserSubscriptionBodyParam = insightsCommons.constructCobrandandUserPatchRequest(InsightsConstants.USER_SUBSCRIPTION_CONTEXT,insightName,entityParameterName,thresholdNameValueType,"",duration,editSubscription,isUserSubscribed,patchEntityIds,entityIdsMap);
		...
		expectedResultValues = insightsGenerics.getExpectedAttributesToBeValidated(testCaseId, insightName, triggerType, "OTHER", entityParameterName, thresholdNameValueType, Integer.parseInt(numberOfInsights), numberOfKeys, 
	...
	public void prepareAutomationReport() throws Exception {
		TestInfo testInfo = new TestInfo();
		testInfo = insightsHelper.printSummaryOfTests(notificationsTestSummary,"GET  CategorizeTransactions Insight",testInfo);		
