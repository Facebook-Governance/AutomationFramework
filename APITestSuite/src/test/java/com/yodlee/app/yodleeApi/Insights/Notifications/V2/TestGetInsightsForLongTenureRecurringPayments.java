...
public class TestGetInsightsForLongTenureRecurringPayments extends Base {
    ...
    String accountEntitySchema = "LongTenureRecurringPaymentsAccountEntitySchema.json";
	...
	public void setUp() throws Exception {
	    ...
	    userInfo.setUsername("LongTenRecrPaymtV2" + System.currentTimeMillis());
	...
	public void initializations() throws Exception {		
		...
		automationTestResults.setInsights("LongTenureRecurringPaymentsV2");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetLongTenureRecurringPaymentsInsight.csv")
