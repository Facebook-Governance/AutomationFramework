...
public class TestGetInsightsForSpendingbyMerchantAllAccounts extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForSpendingbyMerchantAllAccounts.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Spending By Merchant AllAccounts Insight");
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("SpendingbyMerchantAllAccounts");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetSpeMerAllAcctsInsight.csv")
	public void testGetNotificationsForSpendingbyMerchant(String testCaseId, String testCaseDescription,
			...
			String isCobrandSubscribed, String isUserSubscribed, String schema, String duration, String frequency, String accountName,
	...
	public void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("SpenMercAllAcc" + System.currentTimeMillis());
