 ...
 *
 */
public class TestYSLIntegrationBugs extends Base {

	public static final String testMFAProviders = "\\TestData\\CSVFiles\\Sdg\\GetProvider.csv";
	CommonUtils commonUtils = new CommonUtils();
	SessionHelper sessionHelper = new SessionHelper();

	@Source(testMFAProviders)
	@Test(enabled = true, groups = { TestGroup.SDG, TestGroup.REGRESSION }, dataProvider = "feeder")
	public void testGetProviders(String testCaseId, String testCaseName, String sequence, String sequenceFilePath,
			String sequenceResFile, String subrand, String cobrand, String enabled, String usTestCaseId, String priority,
		...
		try {
			...
			System.out.println("*********Completed testGetProviders()***********");

		} catch (Exception e) {
			e.printStackTrace();
			Assert.fail("Failed to execute testGetProviders() case due to : " + e);
		}
	}
}
