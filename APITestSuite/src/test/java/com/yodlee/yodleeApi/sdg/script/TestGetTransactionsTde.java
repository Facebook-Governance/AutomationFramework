 ...
 *
 */
public class TestGetTransactionsTde extends Base {

	public static final String getTranxTDE = "\\TestData\\CSVFiles\\Sdg\\KalamReleaseTDE\\getTransactionTde.csv";
	...
	@Info(userStoryId = "B-18763")
	@Source(getTranxTDE)
	public void testGetTranxTde(String usTestcaseId, String tcId, String tcName, String sequence,
			String sequenceFilePath, String sequenceResFile, String subrand, String cobrand, String enabled,
			String priority, String loginFormType, String granularCat) throws Exception {
		...
		try {
			...
			e.printStackTrace();
			Assert.fail("Failed to execute testGetTranxTde() case due to : " + e);
		}
	}
