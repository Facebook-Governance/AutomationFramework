 ...
 * @author mkrishnasamy
 */
public class TestSRSRefreshEligibityStateBasicAggBankTxn extends Base {

	public static final String testSRSRefreshEligibityStateBasicAggr = "\\TestData\\CSVFiles\\Sdg\\BASICAGG_HOLDER_SRS_BANK.csv";
	...
	public static final String GET_ENV_SPEC_CREFRESH_KEY_SETTING_BANK_TXN= "select is_cache_refresh_suprt_en, configs from attribute_cob_config where attribute_id in (5,13) and cobrand_id=10000004 and configs like '%bank%'";
	...
	public void testSRSRefreshEligibityStateBasicAggrWithBankTransactions(String testCaseId, String tcId, String tcName, String sequence,
		...
		try {
			...
			Connection con=dBHelper.getDBConnection();
			  ...
			  //Get Default attribute cob config cache key setting for the attributes 5 and 13
			  String defaultAttrquery = GET_ENV_SPEC_CREFRESH_KEY_SETTING_BANK_TXN;
		      ...
		      //Post account addition, ensure that the refresh_eligibility state id value is set as 6 or 3 based on the config parameters
