 ...
 * @author mkrishnasamy
 */
public class TestSRSRefreshEligibityStateBasicAggregation extends Base {

	public static final String testSRSRefreshEligibityStateBasicAggr = "\\TestData\\CSVFiles\\Sdg\\BASICAGG_HOLDER_SRS.csv";
