 ...
 *
 */
public class TestPassingOnlyDataSets extends Base {
	
	public static final String passingOnlyDataSets = "\\TestData\\CSVFiles\\Sdg\\PassingOnlyDataSets.csv";
	CommonUtils commonUtils = new CommonUtils();
	SessionHelper sessionHelper = new SessionHelper();
	
	@Source(passingOnlyDataSets)
	@Test(enabled = true, groups = { TestGroup.SDG, TestGroup.REGRESSION }, dataProvider = "feeder")
	public void testPassingOnlyDataSets(String usTestCaseId, int testCaseId, String testCaseName, String sequence,
		...
		try {
			...
			System.out.println("*********Completed TestPassingOnlyDataSets***********");

		} catch (Exception e) {
			e.printStackTrace();
			Assert.fail("Failed to execute testPassingOnlyDataSets() case due to : " + e);
