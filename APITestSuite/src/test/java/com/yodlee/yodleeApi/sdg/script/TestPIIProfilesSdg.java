...
public class TestPIIProfilesSdg extends Base {

	public static final String testPIIprofilesSdg = "\\TestData\\CSVFiles\\Sdg\\PII.csv";
	...
	public void testSingleDataGathering(String UsTestCaseId, String tcId, String tcName, String sequence,
		...
		try {
			...
			e.printStackTrace();
			Assert.fail("Failed to execute testSingleDataGathering() case due to : " + e);
