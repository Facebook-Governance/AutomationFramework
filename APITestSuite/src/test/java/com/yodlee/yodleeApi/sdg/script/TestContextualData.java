 ...
 *
 */
public class TestContextualData extends Base {

	public static final String testContextualData = "\\TestData\\CSVFiles\\Sdg\\ContextualData.csv";
	EnvSession envSessionObj = null;
	CommonUtils commonUtils = new CommonUtils();
	SessionHelper sessionHelper = new SessionHelper();

	@Source(testContextualData)
	@Test(enabled = true, groups = { TestGroup.SDG, TestGroup.REGRESSION }, dataProvider = "feeder")
	public void testContextualData(String usTestcaseId, int testCaseId, String testCaseName, String sequence,
		...
		try {
			...
			e.printStackTrace();
			Assert.fail("Failed to execute testContextualData() case due to : " + e);
		}
	}
