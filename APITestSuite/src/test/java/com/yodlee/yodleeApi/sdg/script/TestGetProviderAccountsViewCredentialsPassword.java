 ...
 *
 */
public class TestGetProviderAccountsViewCredentialsPassword extends Base {

	public static final String testMFAQuetionAndAnswer2 = "\\TestData\\CSVFiles\\Sdg\\EditMFAQandA2.csv";
	CommonUtils commonUtils = new CommonUtils();
	SessionHelper sessionHelper = new SessionHelper();

	@Source(testMFAQuetionAndAnswer2)
	@Test(enabled = true, groups = { TestGroup.SDG, TestGroup.REGRESSION }, dataProvider = "feeder")
	public void testGetProviderAccountsViewCredentialsPassword(String usTestCaseId, int testCaseId, String testCaseName,
		...
		try {
			...
			System.out.println("*********Completed TestGetProviderAccountsViewCredentialsPassword***********");

		} catch (Exception e) {
			e.printStackTrace();
			Assert.fail("Failed to execute testGetProviderAccountsViewCredentialsPassword() case due to : " + e);
