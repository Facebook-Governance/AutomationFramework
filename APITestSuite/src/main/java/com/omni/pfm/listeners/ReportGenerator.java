...
public class ReportGenerator implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		try {
			 ...
			 */
		//	base64OfScreenShot = ((TakesScreenshot)TestBase.getDriver()).getScreenshotAs(OutputType.BASE64);
	...
	public void onFinish(ITestContext context) {
		...
		log.info("----------------------------------------------------------------------------------------\n");
		log.info("****************************************************************************************\n");
		Base.mailReporter += "<tr><td>" + suiteName + "</td><td>" + (int)(passed + failed + skipped)
                + "</td><td>" + (int)passed + "</td><td>" + (int)failed + "</td><td>" + (int)skipped + "</td><td>"+formatter.format((passed/(passed + failed + skipped))*100)+" %</td></tr>";
