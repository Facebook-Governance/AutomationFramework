...
public class TestGetInsightsForYourSpendingLastMonthComparedToYourAverage extends Base {

	public static Long providerAccountId = null;
	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForYourSpendingLastMonthComparedToYourAverage.class);
	...
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Your Spending Last Month Compared to Average Cost Insight");
	...
	public void initializations() throws Exception {
		...
		automationTestResults.setInsights("NETWORTHSUMMARY");
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetYourSpendingLastMonthComparedToYourAverage.csv")
	public void testGetNotificationsForYourSpendingLastMonthComparedToYourAverageInsight(String testCaseId,
			String testCaseDescription, String insightName, String triggerCheckEnabled, String inputContainers,
			String triggerType, long providerId, String dagUserName, String dagPassword, String accountGroupName,
			...
			String schema, String duration, String frequency, String accountName, String patchEntityIds,
		...
		if (Boolean.parseBoolean(editSubscription)) {
			...
			if (entityParameterName.equalsIgnoreCase("view")) {
				String patchUserSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(
						...
						duration, editSubscription, "False", patchEntityIds, entityIdsMap);
			...
			if (!isUserSubscribed.isEmpty()) {
				String patchUserSubscriptionBodyParam = insightsCommons.constructSubscriptionPatchRequest(
						...
						thresholdNameValueType, frequency, duration, editSubscription, isUserSubscribed, patchEntityIds,
						entityIdsMap);
				httpParams = insightsHelper.getHttpParams(InsightsConstants.USER_SUB_REQUEST, null, null,
						jwtUserAuthToken, null, null, null, null);
				httpParams.setBodyParams(patchUserSubscriptionBodyParam);
	...
	public void addAccount(long providerId, String dagUserName, String dagUserPassword, String inputContainers) {
		try {
			...
			if (!dagUserName.isEmpty()) {
				...
				userInfo.setUsername("HBnS" + System.currentTimeMillis());
