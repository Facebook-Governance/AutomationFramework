...
public class TestGetInsightsForDuplicateTransactions extends Base {
	public static Long providerAccountId = null;

	protected Logger logger = LoggerFactory.getLogger(TestGetInsightsForDuplicateTransactions.class);
	...
	String accountEntitySchema = "DuplicateTransactions.json";
	
	
	
	@BeforeClass(alwaysRun = true)
	public void setUp() throws Exception {
		System.out.println("Initiated execution for Duplicate Transactions Insight");
	    ...
	    userInfo.setUsername("DpTxn" + System.currentTimeMillis());
		...
		"InsightPDV.bank15", "bank15", sessionObj);
	...
	@Source("\\TestData\\CSVFiles\\Insights\\V2Feeds\\GetDuplicateTransactionInsight.csv")
	public void testGetNotificationsForDuplicateTransaction(String testCaseId,String testCaseDescription,String insightName,String triggerCheckEnabled,String triggerType,String entityParamsCount,String entityParameterName,String thresholdNameValueType,String noumberOfInsights,String editSubscription
