...
public class Budget_Summary_EditPopup_Test extends TestBase {
	...
	public void verifyEarned() throws Exception {
		...
		if (Config.appFlag.equals("app") || Config.appFlag.equals("emulator")) {
			...
			SeleniumUtil.click(budget_Edit.EditTextBox().get(12));
	...
	public void bdgtAmtInBlack() throws Exception {
		...
		SeleniumUtil.click(budget_Edit.EditTextBox().get(13));
		SeleniumUtil.waitForPageToLoad();
		String blackColor = budget_Edit.AmtField_Color().get(13).getCssValue("color");
	...
	public void verifyEditWithNumerals() throws Exception {
		logger.info(">>>>> Verifying APPLY button update the amount which edit ");
		SeleniumUtil.waitForPageToLoad();
		if (Config.appFlag.equals("app") || Config.appFlag.equals("emulator")) {
			SeleniumUtil.click(budget_Edit.backBtnMob());
	...
	public void verifyEditWithZero() throws Exception {
	...
	public void verifyEditWithMorethan11_digits() throws Exception {
