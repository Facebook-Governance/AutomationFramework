...
public class Budget_BudgetSummery_Data5_Test extends TestBase {
	...
	public void doInit() throws Exception {
		doInitialization("Budget Summary TestData5");
		...
		Assert.assertTrue(
				accountAddition.addAggregatedAccount(PropsUtil.getDataPropertyValue("Budget_BudgetSummery_Data5_Site"),
						PropsUtil.getDataPropertyValue("Budget_BudgetSummery_Data5_Password")));
		PageParser.forceNavigate("Budget", d);
		SeleniumUtil.waitForPageToLoad();
		budgetCreateBudgetLoc.createBudgetGroup(PropsUtil.getDataPropertyValue("Budget_MovieBudget"));
	}

	@Test(description = "AT-108745:Verify Income label in income progress bar", priority = 28)
	public void verifyIncomeproBarDetails5() {
		...
		if (Config.appFlag.equalsIgnoreCase("app") || Config.appFlag.equalsIgnoreCase("emulator")) {
			Assert.assertEquals(incomeProBarMesg + " " + incomeEraned + " " + incomeBudgeted,
					PropsUtil.getDataPropertyValue("Budget_MovieSummeryProIncomeInfoMesgMobile"),
			...
			// PropsUtil.getDataPropertyValue("Budget_MovieSummeryProIncomeWidthMobile"),
			// "width is not dispalyed");
			// Assert.assertEquals(budgetSummary.budget_Summery_IncomeRemain().getCssValue("width"),
			// PropsUtil.getDataPropertyValue("Budget_MovieSummeryProIncomeRemainWidthMobile"),
			// "width is not dispalyed");

		} else {
			Assert.assertEquals(incomeProBarMesg + " " + incomeEraned + " " + incomeBudgeted,
					PropsUtil.getDataPropertyValue("Budget_MovieSummeryProIncomeInfoMesg"),
					"income earned and budgeted income is not displayed");
			// Assert.assertTrue(budgetSummary.budget_Summery_IncomeColor().getCssValue("width").contains(PropsUtil.getDataPropertyValue("Budget_MovieSummeryProIncomeWidth")),
			// "width is not dispalyed");
			// Assert.assertTrue(budgetSummary.budget_Summery_IncomeRemain().getCssValue("width").contains(PropsUtil.getDataPropertyValue("Budget_MovieSummeryProIncomeRemainWidth")),
			// "width is not dispalyed");

		}
		Assert.assertEquals(budgetSummary.budget_Summery_IncomeColor().getCssValue("background-color"),
				PropsUtil.getDataPropertyValue("Budget_MovieSummeryProIncomeColor"),
		...
		Assert.assertEquals(budgetSummary.budget_Summery_IncomeRemain().getCssValue("background-color"),
				PropsUtil.getDataPropertyValue("Budget_MovieSummeryProIncomeRemainColor"),
				"background color is not dispalyed");
		// Assert.assertTrue(budgetSummary.budget_Summery_IncomeColor().getAttribute("style").contains("99%"),"width
		// should be 100%");
		System.out.println(budgetSummary.budget_Summery_IncomeRemain().getAttribute("style"));
		// Assert.assertTrue(budgetSummary.budget_Summery_IncomeRemain().getAttribute("style").contains("94.2%"),"width
		// should be 100%");
	}

	@Test(description = "AT-108745:Verify Spending label in spending progress bar", priority = 29, dependsOnMethods = "verifyIncomeproBarDetails5")
	public void verifySpendingproBarDetails5() {
		...
		Assert.assertEquals(spendingLabel, PropsUtil.getDataPropertyValue("Budget_MovieSummeryProSpendingLbl"),
		...
		if (Config.appFlag.equalsIgnoreCase("app") || Config.appFlag.equalsIgnoreCase("emulator")) {
			Assert.assertEquals(spendingProBarMesg + " " + spendingValue + " " + budgtedSpendValue,
					PropsUtil.getDataPropertyValue("Budget_MovieSummeryProSpendingInfoMesgMobile"),
					"spend and budgeted spend is not displayed");
			// Assert.assertEquals(budgetSummary.budget_Summery_SpendColor().getCssValue("width"),
			// PropsUtil.getDataPropertyValue("Budget_MovieSummeryProSpendingWidthMobile"),
			// "width is not dispalyed");
			// Assert.assertEquals(budgetSummary.budget_Summery_SpendRemain().getCssValue("width"),
			// PropsUtil.getDataPropertyValue("Budget_MovieSummeryProSpendingRemainWidthMobile"),
			// "width is not dispalyed");

		} else {
			Assert.assertEquals(spendingProBarMesg + " " + spendingValue + " " + budgtedSpendValue,
					PropsUtil.getDataPropertyValue("Budget_MovieSummeryProSpendingInfoMesg"),
					"spend and budgeted spend is not displayed");
			// Assert.assertTrue(budgetSummary.budget_Summery_SpendColor().getCssValue("width").contains(PropsUtil.getDataPropertyValue("Budget_MovieSummeryProSpendingWidth")),
			// "width is not dispalyed");
			// Assert.assertTrue(budgetSummary.budget_Summery_SpendRemain().getCssValue("width").contains(PropsUtil.getDataPropertyValue("Budget_MovieSummeryProSpendingRemainWidth")),
			// "width is not dispalyed");

		}
		Assert.assertEquals(budgetSummary.budget_Summery_SpendColor().getCssValue("background-color"),
				PropsUtil.getDataPropertyValue("Budget_MovieSummeryProSpendingColor"),
				"background color is not dispalyed");
		Assert.assertEquals(budgetSummary.budget_Summery_SpendRemain().getCssValue("background-color"),
				PropsUtil.getDataPropertyValue("Budget_MovieSummeryProSpendingRemainColor"),
				"background color is not dispalyed");
		// Assert.assertTrue(budgetSummary.budget_Summery_SpendColor().getAttribute("style").contains("100%"),"width
		// should be 100%");
		Assert.assertTrue(budgetSummary.budget_Summery_SpendRemain().getAttribute("style").contains("55.02%"),
				"width should be 100%");
	}

	@Test(description = "AT-108745:Verify budgeted income value in legends", priority = 30, dependsOnMethods = "verifyIncomeproBarDetails5")
	public void verifyBudgetedIncome5() {
		...
		Assert.assertEquals(budgetedIncomelabel,
				PropsUtil.getDataPropertyValue("Budget_MovieSummeryLegendActualIncomeLbl"),
		...
		Assert.assertEquals(proBarColor,
				PropsUtil.getDataPropertyValue("Budget_MovieSummeryLegendActualIncomeLblColor"), "");

	}

	@Test(description = "AT-108745:Verify spending value in legends", priority = 31, dependsOnMethods = "verifyIncomeproBarDetails5")
	public void verifyActualSpending5() {
		...
		Assert.assertEquals(actualSpendingLabel,
				PropsUtil.getDataPropertyValue("Budget_MovieSummeryLegendActualSpendingLbl"),
	...
	@Test(description = "AT-108745:Verify left over value in legends", priority = 32, dependsOnMethods = "verifyIncomeproBarDetails5")
	public void verifyLeftOverSpending5() {
		if (Config.appFlag.equalsIgnoreCase("app") || Config.appFlag.equalsIgnoreCase("emulator")) {
