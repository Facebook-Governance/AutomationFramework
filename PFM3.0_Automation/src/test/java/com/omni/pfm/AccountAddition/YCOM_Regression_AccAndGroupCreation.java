 ...
 * @author
 ******************************************************************************/
package com.omni.pfm.AccountAddition;
...
public class YCOM_Regression_AccAndGroupCreation extends TestBase {
    private static final Logger logger = LoggerFactory.getLogger(YCOM_Regression_AccAndGroupCreation.class);
    AccountAddition accAddition = new AccountAddition();
    public static String theme;
    String pageName = "AccountsPage";
 ...
 * @throws Exception *************************************************/
	...
	//	SeleniumUtil.click(d.findElement(By.xpath("//button[contains(@aria-label,'All Done')]")));
        ...
        WebElement AllDoneAG = SeleniumUtil.getWebElement(d, "AllDoneAG", pageName , frameName);

		SeleniumUtil.click(AllDoneAG);
		SeleniumUtil.waitForPageToLoad(5000);
	}
