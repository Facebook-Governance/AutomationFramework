...
public class User_RegAdd_Transaction_Tag_Test extends TestBase {
	...
	private static final Logger logger = LoggerFactory.getLogger(User_RegAdd_Transaction_Tag_Test.class);
    LoginPage login;
