...
public class FincheckV2_Pay_Bills_On_Time_Loc {
	WebDriver d;
	String pageName, frameName;

	public FincheckV2_Pay_Bills_On_Time_Loc(WebDriver d) {
		this.d = d;
		pageName = "FincheckV2";
		frameName = null;
	}
	...
	public WebElement getIndicatorFromDashboard() {
		return SeleniumUtil.getWebElement(d, "finv2-indicator-2-title", pageName, frameName);
	}
	...
	public WebElement getOverdueBillsText() {
		return SeleniumUtil.getWebElement(d, "fincheck-v2-text-overdue-bills", pageName, frameName);
	}
	public WebElement getUpcomingBillsText() {
		return SeleniumUtil.getWebElement(d, "fincheck-v2-text-upcoming-bills", pageName, frameName);
	}

	public WebElement getOverdueBillsValue() {
		return SeleniumUtil.getWebElement(d, "fincheck-v2-value-overdue-bills", pageName, frameName);
	}
