...
public class Budget_Enhancement_Loc {

	public static WebDriver d;
	String frameName, pageName;
	static WebElement we;
	static Logger logger = LoggerFactory.getLogger(Budget_Enhancement_Loc.class);

	public Budget_Enhancement_Loc(WebDriver d) {
		this.d = d;
		pageName = "Budget";
	}
	...
	public WebElement flexibleSpendingAddIcon() {
		return SeleniumUtil.getVisibileWebElement(d, "addiconStep2element", pageName, frameName);
	}
	public WebElement flexibleSpendingAddIconmob() {
		return SeleniumUtil.getVisibileWebElement(d, "flexiblespendingAddiconmob", pageName, frameName);
	}
	...
	public WebElement myIncomeEditIcon() {
		return SeleniumUtil.getWebElement(d, "myIncomeEditIcon1", pageName, frameName);
	}
	...
	public boolean verifyLeftAmountTextIsDisplayed(String categoryName) {
		return d.findElement(By.xpath("//div[@id='progressView']//span[contains(text(),'" + categoryName
				+ "')]//following::span[contains(@class,'y-secondary-text progress-bar-text')][1]")).isDisplayed();
	...
	public void typeFlexibleSpendingCategoriesValuesmob(String incomeValue) {

		SeleniumUtil.waitForPageToLoad();
		WebElement categoryAmountTextBox1 = SeleniumUtil.getVisibileWebElement(d, "input_search_budgetmob", pageName,
				frameName);

		categoryAmountTextBox1.clear();
		categoryAmountTextBox1.sendKeys(incomeValue);
	}
	...
	public WebElement selectCheckboxAccountNumber(String accountNumber) {
        String xpath=SeleniumUtil.getVisibileElementXPath(d, pageName, frameName, "accountNumber_Bdgt_Grp");
        xpath=xpath.replaceAll("AccountNumber", accountNumber);
        return d.findElement(By.xpath(xpath));
	}
	
	public void createAccountGroup(String[] accountNames) {
		for(int i =0;i<accountNames.length;i++) {
			SeleniumUtil.click(selectCheckboxAccountNumber(accountNames[i]));
	...
	public WebElement cancelButton1() {
			return SeleniumUtil.findElement(d, "cancelButton1", "Budget", null, 5);
		}

	

	public WebElement closecatgButtonmob() {
		return SeleniumUtil.findElement(d, "closeCategoriesForMobile", "Budget", null, 5);

	}

	
	public WebElement CloseAlertsettingbtn() {
		return SeleniumUtil.findElement(d, "CloseAlertsettingbtn", "Budget", null, 5);
	}

	public WebElement MobSaveChangesButton_CB() {
		return SeleniumUtil.findElement(d, "MobleSaveChangesButton_CB", "Budget", null, 5);
	}

	public WebElement flexibleSpendingEditIconmob() {
		return SeleniumUtil.getVisibileWebElement(d, "flexiblespendingediticonmob", pageName, frameName);
	}

	public WebElement myIncomeEditIconmob() {
		return SeleniumUtil.getWebElement(d, "myIncomeEditIconmob", pageName, frameName);
	}

	public WebElement incomeNextButtonmob() {
		return SeleniumUtil.getWebElement(d, "incomeNextButtonmob", pageName, frameName);
	}

	public WebElement BudgetSetting() {
		return SeleniumUtil.getWebElement(d, "BudgetSetting", pageName, frameName);

	}

	public WebElement budgetaccheader() {
		return SeleniumUtil.getWebElement(d, "budgetaccheader", pageName, frameName);
	...
	public WebElement getBackButtonmob_BSA() {
		return SeleniumUtil.getWebElement(d, "MobileBackButton_BSA", "Budget", null);
	}

	public WebElement featureTourNextButton1(int i) {
		return d.findElement(By.xpath("(//a[contains(@class,'joyride-next-tip')])[ + n + ]"));
	}
	public WebElement featureTourCloseIcon2() {
        return SeleniumUtil.getVisibileWebElement(d, "featureTourCloseIcon2_BIABS", pageName, frameName);
 }
